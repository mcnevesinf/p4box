...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".parse_vxlan_gpe") state parse_vxlan_gpe {
        ...
        transition select(hdr.vxlan_gpe.next_proto) {
            8w0x5 &&& 8w0xff: parse_gpe_int_header;
...
control process_egress_system_acl(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".egress_copy_to_cpu") action egress_copy_to_cpu() {
        clone3(CloneType.E2E, (bit<32>)32w250, { meta.ingress_metadata.bd, meta.ingress_metadata.ifindex, meta.fabric_metadata.reason_code, meta.ingress_metadata.ingress_port, standard_metadata.instance_type });
    }
...
control process_ingress_sflow(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".sflow_ing_pkt_to_cpu") action sflow_ing_pkt_to_cpu(bit<32> sflow_i2e_mirror_id) {
        ...
        clone3(CloneType.I2E, (bit<32>)sflow_i2e_mirror_id, { { meta.ingress_metadata.bd, meta.ingress_metadata.ifindex, meta.fabric_metadata.reason_code, meta.ingress_metadata.ingress_port, standard_metadata.instance_type }, meta.sflow_metadata.sflow_session_id, meta.i2e_metadata.mirror_session_id, meta.ingress_metadata.egress_ifindex });
    }
...
control process_system_acl(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".copy_to_cpu") action copy_to_cpu(bit<5> qid, bit<32> meter_id, bit<3> icos) {
        meta.intrinsic_metadata.qid = qid;
        meta.intrinsic_metadata.ingress_cos = icos;
        clone3(CloneType.I2E, (bit<32>)32w250, { meta.ingress_metadata.bd, meta.ingress_metadata.ifindex, meta.fabric_metadata.reason_code, meta.ingress_metadata.ingress_port, standard_metadata.instance_type });
